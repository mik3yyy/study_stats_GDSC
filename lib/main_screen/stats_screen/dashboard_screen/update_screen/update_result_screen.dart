...
import 'package:study_stats/main_screen/stats_screen/dashboard_screen/update_screen/update_function.dart';
...
class UpdateResult extends StatefulWidget {
  const UpdateResult(
      {key, required this.cgpa, required this.current_gpa});
  final String cgpa;
...
class _UpdateResultState extends State<UpdateResult> {
  ...
  void initState() {
    ...
    print(goal);
    data = UpdateFunction.getUpdateResult(
